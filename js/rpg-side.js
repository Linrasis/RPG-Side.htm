...
function setmode(newmode, newgame){
    ...
    document.getElementById('page').innerHTML = '<div><div><a onclick="setmode(1, true)">Test Level</a></div></div><div class=right><div><input disabled value=Click>Cast Spell<br><input id=jump-key maxlength=1 value='
